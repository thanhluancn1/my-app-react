    ...
    <div className="flex flex-col gap-6 items-start relative w-full p-6 bg-bg-light min-h-screen">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between relative w-full gap-4">
        ...
        <div className="flex gap-2 items-center">
          <h1 className="font-roboto font-medium text-2xl text-text-primary whitespace-nowrap">
            Gợi ý đề thi
          </h1>
        </div>
        ...
        <div className="flex gap-3 items-center justify-end">
          ...
          <button 
            ...
            className="bg-primary flex gap-1 items-center px-3 py-2 rounded-lg hover:bg-blue-600 transition-colors shadow-sm"
          >
            <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4v16m8-8H4"></path>
            </svg>
            <span className="font-inter font-normal text-base text-white whitespace-nowrap">
              Tạo đề từ ma trận
            </span>
          </button>
          
          <button className="bg-white border border-border-medium flex gap-2 h-10 items-center justify-center px-4 py-3 rounded-lg hover:bg-gray-50 transition-colors shadow-sm">
            <svg className="w-6 h-6 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"></path>
            </svg>
            <span className="font-inter font-normal text-primary text-base whitespace-nowrap">
              Tải lên đề có sẵn
            </span>
          </button>
        </div>
